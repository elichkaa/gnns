...
from gnns.idgl.layers.graphlearn import GraphLearner
...
from gnns.utils.generic_utils import to_cuda, normalize_adj
...
class GraphClf(nn.Module):
    ...
    def forward(self, node_features, init_adj=None):
        ...
        raw_adj, adj = self.learn_graph(
            self.graph_learner, node_features, self.graph_skip_conn, init_adj=init_adj)
